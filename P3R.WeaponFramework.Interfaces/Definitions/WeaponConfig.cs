...
public class WeaponConfig
{
    ...
    public EShellType Shell { get; set; }
    ...
    [YamlIgnore]
    public bool? HasMultipleModels => ShellType.FromValue(Shell).RequiredMeshes > 1;
...
{ 
    ...
    public string[] DefinedPaths => MeshPaths.Where(path => path != null)!.ToArray<string>();
}
